...
namespace FinalArtsShop.Areas.Admin.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Active,CreatedAt,UpdatedAt")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Active,CreatedAt,UpdatedAt")] City city)
        {
            if (ModelState.IsValid)
            {
